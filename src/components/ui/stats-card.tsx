        ...
        <CardContent className="p-4 sm:p-5 md:p-6">
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1 space-y-2">
              ...
              {trend && (
                <div className="h-3 bg-brand-muted/20 rounded w-28"></div>
              )}
            </div>
        ...
        <div className="">
          ...
          <div className="space-y-2 sm:space-y-4">
            <div className="flex items-center gap-2">
              <p className="flex-3 text-[10px] sm:text-xs font-medium text-brand-muted uppercase tracking-wide">
                {title}
              </p>
            ...
            <p className="text-sm sm:text-base md:text-xl font-bold text-brand-dark leading-tight">
              {value}
            </p>
...
export const CompactStatsCard: React.FC<StatsCardProps> = (props) => {
  return (
    <StatsCard {...props} className={cn("hover:shadow-md", props.className)} />
  );
};

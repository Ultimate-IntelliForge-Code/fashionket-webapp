  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-mmp-accent focus-visible:ring-mmp-accent/30 focus-visible:ring-[3px] focus-visible:bg-white/5",
        "hover:border-mmp-primary/50 hover:bg-white/5",
